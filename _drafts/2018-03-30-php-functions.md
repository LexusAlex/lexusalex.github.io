...
Функции в программировании играют огромную роль, зная и понимая принцип их работы, можно строить надежные программы.
Примеры будут на php, но данные принципы примененимы в целом к программированию.
