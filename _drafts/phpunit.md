...
Спискок версий и их поддержку удобно смотреть на [https://packagist.org/packages/phpunit/phpunit](https://packagist.org/packages/phpunit/phpunit)
...
После установки доступна команда `./vendor/bin/phpunit`
