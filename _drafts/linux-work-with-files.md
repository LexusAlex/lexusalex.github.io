...
Числовой идентификатор пользователя. Система руководствуется имеено идентификатором, а не именем пользователя.
...
*В системе может быть несколько пользователей с одним UID*
