...
плюс необязательными, но о них позже.
...
Исторически сложилось что локально пользователи хранятся в двух таблицах файлов, где каждый пользователь представлен одной строкой:
1. `/etc/passwd` - системный файл паролей.
    Параметры пользователя записаны в 7 полях разделенных символом ` : `
    1. name      :
    2. passwd    : 
    3. uid       :
    4. gid       :
...
2. `/etc/shadow` - теневой файл паролей.
    Здесь параметры пользователя записаны в 9 полях разделенных символом ` : `
    1. name     :
    2. passwd   : 
    3. latching :
    4. min      :
...
Символьное имя пользователя. Длина от 1 до 32 символов
