...
layout: default
nav_order: 79
permalink: 79-php-code-execution-in-the-documentation
title: "Документация php становится интерактивной"
description: "В документацию php добавлена возможность выполнять код прямо на странице"
...
# Документация php становится интерактивной
{: .no_toc }
