...
layout: default
nav_order: 74
permalink: 74-javascript-promises
title: "Promises в javascript"
description: "Основы promises в javascript"
...
`Promise` возвращает метод `fetch`, который мы разберем в одной из [будущих](/93-javascript-fetch) заметок.
