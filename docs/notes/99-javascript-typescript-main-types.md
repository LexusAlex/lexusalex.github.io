...
layout: default
nav_order: 99
permalink: 99-javascript-typescript-main-types
title: "Typescript. Основное использование типов"
description: "Базовое использование типов в typescript"
...
В прошлой [статье](/98-javascript-typescript-installation-and-launch) мы поставили `typescript` и научились запускать код.
