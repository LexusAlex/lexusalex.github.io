...
layout: default
nav_order: 120
permalink: 120-html-css-attribute-id
title: "Глобальные атрибуты. id"
description: "Атрибут id в html"
...
Если нужно, чтобы идентификаторы повторялись, используйте атрибут [`class`](/116-html-css-attribute-class).
