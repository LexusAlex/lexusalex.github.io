...
layout: default
nav_order: 113
permalink: 113-html-css-document-structure-outline
title: "Структура документа. Заголовки. Outline."
description: "Алгоритм Outline. Заголовки в структуре документа."
...
![outline.png](/assets/images/notes/113/html/outline/outline.png)
