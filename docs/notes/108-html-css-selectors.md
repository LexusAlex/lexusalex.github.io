...
layout: default
nav_order: 108
permalink: 108-html-css-selectors
title: "Базовые селекторы в css"
description: "Типы базовых селекторов в css"
...
![Все элементы в рамках контекста](/assets/images/notes/108/css/selectors/universal.png)
...
![Селектор элемента](/assets/images/notes/108/css/selectors/tags.png)
_Селектор элемента_
...
Так же в сочетании с [универсальным селектором](/108-html-css-selectors#универсальный-селектор-) получается такой же результат
...
![Прямой потомок](/assets/images/notes/108/css/selectors/selector-1.png)
_Прямой потомок_
