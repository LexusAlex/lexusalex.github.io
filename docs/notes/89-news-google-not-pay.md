...
layout: default
nav_order: 89
permalink: 89-news-google-not-pay
title: "Google Play прекращает выплаты разработчикам из России, как меняются правила игры"
description: "Google Play с 26 декабря 2024 года приостановила выплаты российским разработчикам, что изменило положение на рынке мобильных приложений. Какие шаги предпринимают разработчики, и какие альтернативы существуют для заработка? Рассказываем о ситуации и возможных выходах из кризиса."
...
# Google Play прекращает выплаты разработчикам из России, как меняются правила игры
{: .no_toc }
