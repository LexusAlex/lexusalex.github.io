...
layout: default
nav_order: 93
permalink: 93-javascript-fetch
title: "Запросы и ответы с fetch в javascript"
description: "Работаем с запросами и ответами с сервера с помощью fetch api"
...
В продолжении темы про [`Promises`](/74-javascript-promises), теперь рассмотрим `fetch`.
