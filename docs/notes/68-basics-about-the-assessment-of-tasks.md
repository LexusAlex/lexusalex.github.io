...
layout: default
nav_order: 68
permalink: 68-basics-about-the-assessment-of-tasks
title: "Про оценку задач"
description: "Мысль про один из больных вопросов для программиста - это оценка времени на выполнение задач"
