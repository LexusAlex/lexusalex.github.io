...
layout: default
nav_order: 100
permalink: 100-javascript-react-start
title: "Начать в React"
description: "Разберем что из себя представляет React, как мощный и гибкий инструмент для создания пользовательских интерфейсов"
...
Когда-то я уже писал про разворачивание [React](/71-javascript-react-pure-react) там мы разворачивали приложение устаревшим способом, с помощью `create react app`
...
![react](/assets/images/notes/100/javascript/react/react-1.png)
...
````jsx
<a href="https://lexusalex.ru" target="_blank">Текст ссылки</a>
````
...
- Можно писать [чистые функции](/69-php-dependency-injection-container#%D1%84%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D1%8F-%D0%B7%D0%B0%D0%B2%D0%B8%D1%81%D1%8F%D1%89%D0%B0%D1%8F-%D0%BE%D1%82-%D1%81%D0%B2%D0%BE%D0%B8%D1%85-%D0%BF%D0%B0%D1%80%D0%B0%D0%BC%D0%B5%D1%82%D1%80%D0%BE%D0%B2)
...
> Небольшую заметку про состояние я уже писал [/66-basics-stateful-and-stateless](/66-basics-stateful-and-stateless)
>
...
![react](/assets/images/notes/100/javascript/react/react-2.png)
_useState_
