...
layout: default
nav_order: 70
permalink: 70-php-php-di
title: "Библиотека php-di"
description: "Рассмотрим библиотеку php-di, как ее использовать в приложениях"
...
В предыдущей статье [/69-php-dependency-injection-container](/69-php-dependency-injection-container) мы поняли что такое контейнер внедрения зависимостей, разобрали где он может быть полезен. 
...
1. [Библиотека laminas-config-aggregator](/65-php-application-configuration-using-the-example-of-laminas-config-aggregator)
2. [Контейнер внедрения зависимостей в php](/69-php-dependency-injection-container)
