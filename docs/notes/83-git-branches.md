...
layout: default
nav_order: 83
permalink: 83-git-branches
title: "Ветки в git"
description: "Суть ветвления в git."
...
В прошлой [статье](/77-git-how-git-stores-changes) мы поняли как git хранит изменения.
...
![img-description](/assets/images/notes/83/git/branch/git-branch-1.png)
