...
layout: default
nav_order: 69
permalink: 69-php-dependency-injection-container
title: "Контейнер внедрения зависимостей в php"
description: "Изучаем что такое контейнер внедрения зависимостей в php."
...
В прошлой статье [/65-php-application-configuration-using-the-example-of-laminas-config-aggregator](/65-php-application-configuration-using-the-example-of-laminas-config-aggregator) мы собрали конфигурацию. 
