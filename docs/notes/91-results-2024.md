...
layout: default
nav_order: 91
permalink: 91-results-2024
title: "Итоги 2024"
description: "Вспоминаем события 2024 года "
...
Обо всех новшествах писал [заметку](/82-javascript-react-new-version-react-19)
...
- `xubuntu` - перешел в этом году на `xubuntu 24.04`, об этом делал заметку [Переход на xubuntu desktop 24.04](/73-linux-switch-xubuntu-2404)
