...
layout: default
nav_order: 116
permalink: 116-html-css-attribute-class
title: "Глобальные атрибуты. class"
description: "Атрибут class в html"
...
Используя `class` мы имеем доступ к элементу через [`css`](/108-html-css-selectors#%D1%81%D0%B5%D0%BB%D0%B5%D0%BA%D1%82%D0%BE%D1%80-%D0%BA%D0%BB%D0%B0%D1%81%D1%81%D0%B0-) и управление элементами через `javascript`.
