...
1. Если над проектом работают несколько человек. Код проекта меняется с колосальной скоростью. 
Приходится постоянно проверять, что результат соответвует ожидаемому. При ручных проверках **проверить весь функционал просто невозможно**.
