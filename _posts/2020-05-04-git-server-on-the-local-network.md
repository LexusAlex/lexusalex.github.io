...
Скопировать ключ на сервер и занести в файл занести в файл `~/.ssh/authorized_keys` можно командой.
...
Если нужно заменить адрес репозитория воспользуемся командой командой.
...
Если нужно развернуть уже созданный проект то клонируем. 
