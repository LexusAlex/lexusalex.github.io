...
comments: true
--- 
Composer занимает особое место в инфраструктуре php. Он выполняет функцию управления зависимостями проекта.
Composer избавляет разработчиков от головной боли по распростанению, обновлению, документированию и переиспользованию своего
кода
